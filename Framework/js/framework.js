    ...
    function framework() {
        ...
        this.show = function (e, src, width, height, title, center, content, rounded, type) {
            ...
            if (type == "image") {
                ...
                $('<div id="overlay_image_content" class="overlay_content"><img src="' + src + '" width="' + total_width + '" height="' + total_height + '" alt="" /></div>').insertAfter('#overlay_bar');
                ...
                $("#" + e).hide().fadeTo("slow", 1).show().css({ 'left': overlay_left, 'width': width, 'height': height });
