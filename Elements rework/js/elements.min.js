(function(a, b) {
    ...
    var H = a.document, I = a.navigator, J = a.location, K = function() {
        ...
        return h.fn = h.prototype = {
            ...
            parseJSON: function(b) {
                return "string" == typeof b && b ? (b = h.trim(b), a.JSON && a.JSON.parse ? a.JSON.parse(b) : p.test(b.replace(q, "@").replace(r, "]").replace(s, "")) ? new Function("return " + b)() : (h.error("Invalid JSON: " + b), 
                void 0)) : null;
            },
            parseXML: function(c) {
                var d, e;
    ...
    K.extend({
        ...
        if (H.documentElement, n.setAttribute("className", "t"), n.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", 
    ...
    K.fn.extend({
        ...
        attr: function(a, c, d, e) {
            ...
            h && (c = c.toLowerCase(), g = K.attrHooks[c] || (Y.test(c) ? Q : P)), d !== b ? null === d ? (K.removeAttr(a, c), 
    ...
    K.event = {
        ...
        K.event.special[a] = {
            ...
            handle: function(a) {
                ...
                return f.selector, (!e || e !== d && !K.contains(d, e)) && (a.type = f.origType, 
    ...
    function b() {
        var b = this;
        b.$dom = a(document), b.click = "click", b.onReady = b.onTouch = !1, b.uiModules = {}, 
        b.inits = {};
    }
    b.prototype.init = function() {
        this.debug("ignition"), this.initUIModules();
        var a = this;
        this.$dom.ready(function() {
            a.onReady && a.onReady(), Modernizr.touch && a.onTouch && a.onTouch();
        });
    }, b.prototype.ready = function(a) {
        a && "function" == typeof a && (this.onReady = a);
    }, b.prototype.touch = function(a) {
        a && "function" == typeof a && (this.onTouch = a);
    }, b.prototype.debuggin = function() {
        return {
            $dom: this.$dom,
            uiModules: this.uiModules,
            click: this.click
        };
    }, b.prototype.selectAttr = function() {
        for (var a = 0; a < arguments.length; a++) {
            var b = arguments[a], c = "data-" + arguments[a], d = "em-" + arguments[a];
            if (this.attr(c)) return this.attr(c);
            if (this.attr(d)) return this.attr(d);
            if (this.attr(b)) return this.attr(b);
        }
        return !1;
    }, b.settings = {
        status: !0,
        ...
        console.log(a);
    }, b.prototype.debug = function(c) {
        b.settings.status && (console.log(c), b.settings.show_output && !a(".output").length && a("body").prepend(b.settings.output));
    }, b.prototype.debug_all = function() {
        if (b.settings.status) {
            var c;
            for (c in arguments) console.log(arguments[c]);
            b.settings.show_output && !a(".output").length && a("body").prepend(b.settings.output);
        }
    }, b.prototype.cla = function(a) {
        return a.slice(1);
    }, b.prototype.sel = function(a) {
        return a.slice(1);
    }, b.prototype.cloneData = function(a) {
        return JSON.parse(JSON.stringify(a));
    }, b.prototype.testDataAttr = function(a, b, c) {
        return void 0 !== a.data(c) ? (b[c] = a.data(c), a.data(c)) : b[c];
    }, b.prototype.updateOptions = function(a, b) {
        var c;
        for (c in b) this.testDataAttr(a, b, c);
    }, b.prototype.addInitalisation = function(a, b) {
        this.inits[a] = b;
    }, b.prototype.initialize = function(a) {
        this.debug("initing " + a), this.inits[a] && "function" == typeof this.inits[a] && this.inits[a]();
    }, b.prototype.UIModule = function(a) {
        this.debug("add ui module"), this.debug(a);
        var b = a.module;
        this.uiModules[b] = a;
    }, b.prototype.initUIModules = function() {
        this.debug("init ui mods"), this.debug(this.uiModules);
        var a;
        for (a in this.uiModules) this.debug(a), this.uiModules[a].init();
    }, window.em = new b();
}(jQuery), function(a, b) {
    "use strict";
    b.effects = {
        shadow: function(b, c, d) {
            a(b).css({
                "-moz-box-shadow": "" + c + " " + d,
                "-webkit-box-shadow": "" + c + " " + d,
                "box-shadow": "" + c + " " + d
            });
        },
        round: function(b, c) {
            a(b).css({
                ...
                "border-radius": c,
                "-khtml-border-radius": c
            });
        },
        rotate: function(b, c) {
            a(b).css({
                "-moz-transform": "rotate(" + c + ")",
                "-webkit-transform": "rotate(" + c + ")",
                transform: "rotate(" + c + ")"
            });
        },
        slide: function(b, c, d) {
            a(b).css({
                "-moz-transition": c + " " + d + ", -moz-transform " + d,
                "-webkit-transition": c + " " + d + ", -webkit-transform " + d,
                "-o-transition": c + " " + d + ", -o-transform " + d,
                transition: c + " " + d + ", transform " + d
            });
        }
    };
}(jQuery, em), function(a, b, c) {
    function d() {
        var d = this;
        this.defaults = {
            type: "default",
            ...
            slide_stop: !0,
            slide_loop: 2
        }, a(c).on("click", g, function() {
            return em.debug("super init show"), d.settings = em.cloneData(a.extend({}, d.defaults)), 
            em.updateOptions(a(this), d.settings), d.init(a(this), d.settings), a(c).data(d.settings.class_bg) ? !0 : (a(c).data(d.settings.class_bg, !0), 
            a(c).on("click", d.settings.class_bg, function() {
                d.close(a(this), d.settings);
            }), a(c).on("click", d.settings.class_close, function() {
                d.close(a(this), d.settings);
            }), a(c).on("keyup", function(b) {
                27 === b.keyCode && a(d.settings.class_bg).is(":visible") && (em.debug("super proto esc"), 
                d.close(a(this), d.settings));
            }), a(b).resize(function() {
                em.debug("super proto resize");
            }), !1);
        }), a("[data-gallery^=]").addClass("gallery");
    }
    var e, f = "zoverlay", g = ".overlay";
    d.prototype = {
        constructor: d,
        init: function(a, b) {
            em.debug("super proto show");
            var c = this;
            em.debug(b.class_bg), em.debug(b), c.bg(a, b), c.shell(a, b), c.populate(a, b), 
            c.bling(a, b), c.raise(a, b), c.afterraise(a, b), c.clean(a, b);
        },
        populate: function(c, d) {
            em.debug("super proto populate"), a(c).hasClass("gallery"), a(d.class_content).html(""), 
            a(d.class_images).html(""), a(d.slide_holder).html(""), a(d.class_frame).length ? a(d.class_frame).html("") : a("<div/>", {
                id: "overlay_frame",
                "class": "overlay_frame"
            }).appendTo("body"), "" !== d.title && d.show_header && a("<h1>" + d.title + "</h1>").appendTo(d.class_content), 
            em.debug("my type = " + d.type);
            var e = 1;
            switch (d.type) {
              case "content_gallery":
                a("[data-type=content_gallery]").first().addClass("isFirst"), a("[data-type=content_gallery]").last().addClass("isLast"), 
                a("[data-type=content_gallery]").find("img").each(function(b) {
                    a(this).attr("id", "con_" + (b + 1)), e++;
                }), d.template && (console.log(d.template), a(b[d.template]).each(function() {
                    console.log(a(this)[0]);
                })), a(c).hasClass("isFirst") && a(d.class_rendered).find(d.class_prev), a(c).hasClass("isLast") && a(d.class_rendered).find(d.class_next).hide(), 
                a(d.class_rendered).data("gal", parseInt(a(c).find("img").attr("id").slice(4))), 
                a(d.class_rendered).find(d.class_next).data("gal", parseInt(a(c).find("img").attr("id").slice(4)) + 1), 
                a(d.class_rendered).find(d.class_prev).data("gal", parseInt(a(c).find("img").attr("id").slice(4)) - 1), 
                a("#" + d.element).clone(!0, !0).appendTo(d.slide_holder).clone(), a(d.slide_holder).find(".hidden").show().css("position", "relative").css("margin", "0");
                break;

              case "gallery":
                a("[data-gallery^=" + d.gallery + "]").first().addClass("isFirst"), a("[data-gallery^=" + d.gallery + "]").last().addClass("isLast"), 
                a("[data-gallery^=" + d.gallery + "]").find("img").each(function(b) {
                    a(this).attr("id", "od_" + (b + 1)), a(this).clone().appendTo(d.class_frame).attr("id", "image_od_" + (b + 1)), 
                    a(this).clone().appendTo(d.slide_holder).attr("id", "holder_od_" + (b + 1)), e++;
                });
                var f = a("#image_" + a(c).find("img").attr("id")), g = Number(a("#holder_" + a(c).find("img").attr("id")).index()) + 1, h = 0, i = 0;
                em.debug(g), a(d.class_rendered).data("current-slide", g), a("[data-gallery^=" + d.gallery + "]").find("img").each(function(b) {
                    g > b + 1 && (h += a("#image_od_" + (b + 1)).width(), i += a("#image_od_" + (b + 1)).height(), 
                    em.debug(a("#image_od_" + (b + 1)).width()), em.debug(a("#image_od_" + (b + 1)).height())), 
                    e++;
                }), em.debug(f), em.debug(f.width()), em.debug(f.height());
                var j = ((Number(a(b).height()) - Number(f.height())) / 2, (Number(a("body").width()) - Number(f.width())) / 2), k = 0, l = 0, m = a("[data-gallery^=" + d.gallery + "]");
                m.length;
                var n = 1;
                m.each(function() {
                    k += a("#image_od_" + n).width(), l += a("#image_od_" + n).height(), em.debug("my width = " + a("#image_od_" + n).width()), 
                    n++;
                }), a(d.class_rendered).css({
                    width: f.width(),
                    height: f.height(),
                    left: j + "px"
                }), a(d.slide_selector).css({
                    width: f.width(),
                    height: f.height()
                }), "vertical" === d.slide_direction ? a(d.slide_holder).addClass("vertical").css({
                    width: f.width(),
                    height: l
                }) : a(d.slide_holder).addClass("horizontal").css({
                    width: k,
                    height: f.height()
                }), a(d.class_rendered).find(d.slide_holder).css("left", "-" + h + "px"), a(c).hasClass("isFirst") && a(d.class_rendered).find(d.class_prev).hide(), 
                a(c).hasClass("isLast") && a(d.class_rendered).find(d.class_next).hide();
                break;

              case "image":
                a(c).find("img").each(function() {
                    a(this).clone().appendTo(d.class_frame).attr("id", "image_od_" + e), a(c).find("img").attr("id", "od_" + e), 
                    e++;
                }), a(d.class_rendered).css({
                    width: "auto",
                    height: "auto"
                });
                var o = a(c).find("img").attr("src"), p = a(c).find("img").attr("id"), q = a("#image_" + p).width(), r = a("#image_" + p).height();
                (Number(a(b).height()) - Number(r)) / 2, (Number(a("body").width()) - Number(q)) / 2, 
                "" !== d.title && (a('<div class="' + em.cla(d.class_caption) + '"><h1>' + d.title + "</h1></div>").appendTo(d.slide_holder), 
                a(d.class_caption).fadeTo("slow", .6)), a('<img src="' + o + '" alt="' + d.title + '" height="auto" width="auto" /></div>').appendTo(d.class_images), 
                a(d.class_rendered).find(d.slide_holder).width(q).height(r);
                break;

              case "json":
                a(d.class_rendered).append('<div class="' + em.cla(d.class_content) + '">' + ("" !== b[d.call].title ? "<h1>" + b[d.call].title + "</h1>" : "") + b[d.call].content + "</div>");
                break;
              ...
              case "ajax":
                a.ajax({
                    ...
                    crossDomain: !0,
                    success: function(a) {
                        "function" == typeof d.ajax_content ? d.ajax_content(a.data, d) : d.ajax_content && b[d.ajax_content](a.data, d);
                    }
                });
                break;

              case "external":
                for (var s = {}, t = d.params.split(","), u = 0; u < t.length; u++) {
                    var v = t[u].split(":");
                    s[v[0]] = v[u];
                }
                a.ajax({
                    ...
                    data: s,
                    success: function(a) {
                        d.pass_data && (d.overlay_data = a);
                    }
                });
                break;

              default:
                a("#" + d.element).clone(!0, !0).appendTo(d.class_content).clone(), a(d.class_content).find(".hidden").show().css("position", "relative").css("margin", "0");
            }
        },
        afterraise: function(c, d) {
            em.debug("super proto after");
            var e = this;
            "function" == typeof callback ? callback(d.overlay_data) : d.callback && b[d.callback](d.overlay_data), 
            d.focus_first && a(d.class_rendered).find("input").first().trigger("focus"), d.force_scroll ? a(d.class_rendered).find(d.class_content).css("overflow-y", "scroll").css("overflow-x", "hidden").height(total_height) : a(d.class_rendered).find(d.class_content).css("overflow", "auto").css("height", "auto"), 
            d.slide_start && (a(d.class_rendered).find(".slide").each(function(b) {
                a(this).attr("data-slide", b + 1).attr("data-set", 1);
            }), e.play(c, d)), a(d.class_rendered).on("click", d.class_next, function() {
                e.move(c, d, "next");
            }), a(d.class_rendered).on("click", d.class_prev, function() {
                e.move(c, d, "prev");
            }), a(c).hasClass("isFirst") && (a(d.class_prev).hide(), a(d.class_next).show()), 
            a(c).hasClass("isLast") && (a(d.class_prev).show(), a(d.class_next).hide()), a(c).hasClass("isLast") || a(c).hasClass("isFirst") || (a(d.class_prev).show(), 
            a(d.class_next).show()), e.reposition(d), d.sticky && a(b).scroll(function() {
                e.reposition_bg(d);
            });
        },
        bling: function(a, b) {
            ...
            var c = this;
            b.rounded !== !1 && c.rounded(a, b), b.shadow_size !== !1 && b.shadow_color !== !1 && c.shadow(a, b);
        },
        shell: function(b, c) {
            em.debug("super proto build shell"), a(c.class_rendered).remove(), a("<div/>", {
                id: em.cla(c.class_rendered),
                "class": em.cla(c.class_holder) + " " + c.data_class
            }).prependTo("body"), c.show_x && a("<div/>", {
                id: em.cla(c.class_bar),
                "class": em.cla(c.class_bar),
                html: '<a href="javascript: void(0);" class="' + em.cla(c.class_close) + '"></a>'
            }).prependTo(c.class_rendered), a(b).hasClass("gallery") || a(b).hasClass("content_gallery") ? (a("<div/>", {
                id: em.cla(c.slide_selector),
                "class": em.cla(c.slide_selector),
                html: '<div class="slide_holder"></div>'
            }).insertAfter(c.class_bar), a("<div/>", {
                id: em.cla(c.class_prev),
                "class": em.cla(c.class_prev),
                html: "",
                href: "#nogo"
            }).appendTo(c.class_rendered), a("<div/>", {
                id: em.cla(c.class_next),
                "class": em.cla(c.class_next),
                html: "",
                href: "#nogo"
            }).appendTo(c.class_rendered)) : (a(c.class_prev).remove(), a(c.class_next).remove(), 
            "image" === c.type ? a("<div/>", {
                id: em.cla(c.class_images),
                "class": em.cla(c.class_images),
                html: ""
            }).insertAfter(c.class_bar) : a("<div/>", {
                id: em.cla(c.class_content),
                "class": em.cla(c.class_content),
                html: ""
            }).insertAfter(c.class_bar));
        },
        clean: function() {
        ...
        raise: function(c, d) {
            ...
            var e = "user" == d.width ? "auto" : d.width, f = "user" != d.max_height && f > d.max_height ? d.max_height : "auto", g = (Number(a(b).height()) - Number(f)) / 2, h = (Number(a("body").width()) - Number(e)) / 2, i = {
                paddingHeight: parseInt(a(d.class_content).css("padding-top")) + parseInt(a(d.class_content).css("padding-bottom")),
                paddingWidth: parseInt(a(d.class_content).css("padding-left")) + parseInt(a(d.class_content).css("padding-right"))
            }, j = parseInt(f) + parseInt(i.paddingHeight), k = parseInt(e) + parseInt(i.paddingWidth);
            "user" !== d.height ? a(d.class_rendered).hide().fadeTo("slow", 1).show().css({
                left: h,
                width: k,
                height: j,
                "min-height": j,
                "min-width": k
            }) : a(d.class_rendered).hide().fadeTo("slow", 1).show().css({
                left: h,
                width: e,
                height: f,
                "min-height": j,
                "min-width": k
            }), a(d.class_rendered).css("top", g + a(b).scrollTop());
        },
        close: function(c, d) {
            em.debug("super proto close"), this.stop(), a(d.class_rendered).fadeOut(), a(d.class_bg).hide(), 
            a(b).unbind("scroll"), a("body").trigger("close_overlay");
        },
        shadow: function(b, c) {
            c.shadow_size !== !1 && c.shadow_color !== !1 && (em.debug("super shadow"), em.effects.shadow(a(c.class_rendered), c.shadow_size, c.shadow_color));
        },
        rounded: function(b, c) {
            c.rounded !== !1 && (em.debug("super round"), em.effects.round(a(c.class_rendered), c.rounded));
        },
        bg: function(b, c) {
            em.debug("super bg"), a(c.class_bg).length || a("<div/>", {
                id: em.cla(c.class_bg),
                "class": em.cla(c.class_bg) + " " + em.cla(c.class_spinner)
            }).appendTo("body"), a(c.class_bg).fadeTo("fast", "0.60");
        },
        reposition: function(c) {
            if (em.debug("super proto repo"), a(c.class_holder).length) {
                var d = (Number(a(b).height()) - Number(a(c.class_rendered).height())) / 2, e = (Number(a("body").width()) - Number(a(c.class_rendered).width())) / 2;
                d = 0 > d ? 50 : d, c.gallery !== !1 ? a(c.class_rendered).animate({
                    left: e,
                    top: d + a(b).scrollTop()
                }, c.slide_delay) : a(c.class_rendered).css({
                    left: e,
                    top: d + a(b).scrollTop()
                });
            }
        },
        reposition_bg: function(c) {
            em.debug("super proto repo bg"), a(c.class_bg).length && a(c.class_bg).css({
                top: a(b).scrollTop(),
                left: a(b).scrollLeft(),
                height: a(b).height() + 30,
                width: a(b).width()
            });
        },
        move: function(b, c, d) {
            em.debug("super move");
            var e = this, f = Number(a(c.class_rendered).data("current-slide"));
            a("#image_od_" + f).width(), a("#image_od_" + f).height();
            var g = Number(a(c.class_rendered).data("current-slide")), h = Number(a(c.class_rendered).data("current-slide")) - 1, i = "-";
            em.debug("slide was " + g), "prev" === d ? (g = parseInt(g) - 1, i = "-") : "next" === d && (g = parseInt(g) + 1, 
            i = "+"), em.debug("slide now is " + g), a(c.class_rendered).data("current-slide", g);
            var j = a("#image_od_" + g).width(), k = a("#image_od_" + g).height(), l = c.title, m = (-(g * a("#image_od_" + h).width() - a("#image_od_" + h).width()), 
            -(g * a("#image_od_" + h).height() - a("#image_od_" + h).height()), 0), n = 0;
            "fade" == c.slide_effect ? (a(c.class_rendered).find("img").fadeOut(), em.debug(a(c.class_rendered).find(c.slide_holder).find("img").eq(g - 1)), 
            a(c.class_rendered).find(c.slide_holder).css("left", 0).find("img").eq(g - 1).fadeIn(), 
            a(c.class_rendered).animate({
                width: j,
                height: k
            }, c.slide_delay, function() {
                e.reposition(c);
            }), a(c.class_rendered).find(c.slide_selector).animate({
                width: j,
                height: k
            }, c.slide_delay)) : (a(c.class_frame).find("img").each(function(b) {
                g > b + 1 && (m += a(this).width(), n += a(this).height(), em.debug("pushing " + a(this).width()));
            }), em.debug(m), "horizontal" === c.slide_direction ? (em.debug(j), em.debug(k), 
            em.debug(g), em.debug(h), a(c.class_rendered).find(c.slide_holder).animate({
                left: "-" + m
            }, c.slide_delay), a(c.class_rendered).animate({
                width: j,
                height: k
            }, c.slide_delay, function() {
                e.reposition(c);
                ...
                width: j,
                height: k
            }, c.slide_delay), m = 0, n = 0) : (a(c.class_rendered).animate({
                width: j,
                height: k
            }, c.slide_delay, function() {
                e.reposition(c);
                ...
                width: j,
                height: k
            }, c.slide_delay), a(c.class_rendered).find(c.slide_holder).animate({
                width: j,
                top: "-" + n
            }, c.slide_delay))), a("#image_od_" + g).is(":first-child") && (a(c.class_prev).hide(), 
            a(c.class_next).show(), em.debug("zombie")), a("#image_od_" + g).is(":last-child") && (a(c.class_prev).show(), 
            a(c.class_next).hide(), em.debug("orge")), a("#image_od_" + g).is(":first-child") || a("#image_od_" + g).is(":last-child") || (a(c.class_prev).show(), 
            a(c.class_next).show(), em.debug("goblin")), "" !== l && (a(c.class_caption).find("h1").text(l), 
            a(c.class_caption).fadeTo("slow", .6));
        },
        play: function() {
            em.debug("super proto play");
        },
        stop: function() {
            em.debug("super stop"), clearInterval(e);
        },
        jump_to: function() {
            em.debug("super jump");
        },
    ...
    }, em.addInitalisation(f, function() {
        em.debug(f + " initialized"), new d();
    }), em.UIModule({
        module: f,
        events: [],
        init: function() {
            em.debug("run " + f + " init"), em.initialize(f);
        }
    });
}(jQuery, window, document), function() {
    "use strict";
    window.em.init(), "function" == typeof define && define.amd && define(window.em);
}(jQuery, em);