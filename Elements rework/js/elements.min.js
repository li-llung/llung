(function(a, b) {
    ...
    "use strict";
    function a() {
        this.$dom = $(document), this.isOldie = !!this.$dom.find("html").hasClass("oldie"), 
        this.click = "click", this.onReady = this.onOldie = this.onTouch = !1, this.uiModules = {}, 
        this.inits = {}, this.path = $("script[gumby-path]").attr("gumby-path") || $("script[data-path]").attr("data-path") || $("script[path]").attr("path") || "js/libs";
    }
    a.prototype.init = function() {
        this.initUIModules();
        var a = this;
        this.$dom.ready(function() {
            a.onReady && a.onReady(), a.isOldie && a.onOldie && a.onOldie(), Modernizr.touch && a.onTouch && a.onTouch();
        });
    }, a.prototype.ready = function(a) {
        a && "function" == typeof a && (this.onReady = a);
    }, a.prototype.oldie = function(a) {
        a && "function" == typeof a && (this.onOldie = a);
    }, a.prototype.touch = function(a) {
        a && "function" == typeof a && (this.onTouch = a);
    }, a.prototype.debuggin = function() {
        return {
            $dom: this.$dom,
    ...
    }, a.prototype.selectAttr = function() {
        ...
        return a.slice(1);
    }, a.prototype.cloneData = function(a) {
        return JSON.parse(JSON.stringify(a));
    }, a.prototype.testDataAttr = function(a, b, c) {
        return void 0 !== a.data(c) ? (b[c] = a.data(c), a.data(c)) : b[c];
    }, a.prototype.updateOptions = function(a, b) {
        var c;
        for (c in b) this.testDataAttr(a, b, c);
    }, a.prototype.addInitalisation = function(a, b) {
        this.inits[a] = b;
    }, a.prototype.initialize = function(a) {
        this.inits[a] && "function" == typeof this.inits[a] && this.inits[a]();
    }, a.prototype.UIModule = function(a) {
        var b = a.module;
        this.uiModules[b] = a;
    }, a.prototype.initUIModules = function() {
        var a;
        for (a in this.uiModules) this.uiModules[a].init();
    }, window.em = new a();
}(), function(a, b) {
    "use strict";
    b.settings = {
...
}(jQuery, em), function(a, b, c, d) {
    function e(b, c) {
        var e = this, f = !1;
        e.el = b, e.$el = a(b), this.scope = this, e.config = {
            height: e.$el.height(),
            width: e.$el.width(),
            title: e.$el.attr("title"),
            href: e.$el.attr("href"),
            hasGallery: e.$el.hasClass("gallery"),
            img: e.$el.find("img"),
            img_width: e.$el.find("img").width(),
            img_height: e.$el.find("img").height(),
            get_id: function() {
                return a(b).attr("id");
            },
            get_slide: function() {
                return a(b).attr("id").split("_")[2];
            },
            is_last: function() {
                return a(b).hasClass("isLast");
            },
            is_first: function() {
                return a(b).hasClass("isFirst");
            }
        }, "trigger" === c && (f = !0), this.defaults = {
            type: "default",
            class_bg: ".modal_bg",
            ...
            class_prev: ".prev",
            class_next: ".next",
            title: a(b).attr("title") === d ? "" : a(b).attr("title"),
            show_header: !0,
            sticky: !1,
            rounded: !1,
            shadow_color: !1,
            ...
            slide_stop: !0,
            slide_loop: 2
        }, e.settings = em.cloneData(a.extend({}, e.defaults, c)), em.updateOptions(b, e.settings), 
        f ? this.show(b, e.settings) : this.init(b, e.settings);
    }
    var f, g = "zoverlay", h = ".overlay";
    e.prototype = {
        constructor: e,
        init: function(b, d) {
            var e = this;
            return a(c).data(d.class_bg) ? !0 : (a(c).data(d.class_bg, !0), a(c).on("click", d.class_bg, function() {
                e.close(b, d);
            }), a(c).on("click", d.class_close, function() {
                e.close(b, d);
            }), void 0);
        },
        show: function(a, b) {
            ...
            var c = this;
            em.debug("----------"), em.debug(c.config), em.debug(c.config.is_first()), em.debug(c.config.is_last()), 
            em.debug(c.config.get_id()), em.debug(c.config.get_slide()), em.debug("----------"), 
            c.bg(a, b), c.shell(a, b), c.populate(a, b), c.bling(a, b), c.raise(a, b), c.afterraise(a, b), 
            c.clean(a, b);
        },
        populate: function(c, d) {
            em.debug("super proto populate");
            var e = a(c).hasClass("gallery");
            a(d.class_content).html(""), a(d.class_images).html(""), a(d.slide_holder).html("");
            var f = 1;
            if (a(d.class_frame).length ? a(d.class_frame).html("") : a("<div/>", {
                id: "overlay_frame",
                "class": "overlay_frame"
            }).appendTo("body"), e) {
                var g = a(c).attr("id").split("_")[2], h = 0, i = 0;
                a("[data-gallery^=" + d.gallery + "]").find("img").each(function(b) {
                    a(this).clone().appendTo(d.class_frame).attr("id", "image_od_" + f), a(this).clone().appendTo(d.slide_holder), 
                    g > b + 1 && (h += a("#image_od_" + f).width(), i += a("#image_od_" + f).height(), 
                    em.debug(a("#image_od_" + f).width()), em.debug(a("#image_od_" + f).height())), 
                    f++;
                }), em.debug(h), em.debug(i), a(d.class_rendered).find(d.slide_holder).css("left", "-" + h + "px"), 
                a(d.slide_selector).css({
                    width: a("#image_od_" + g).width(),
                    height: a("#image_od_" + g).height()
                });
                var j = 0, k = a("[data-gallery^=" + d.gallery + "]"), l = k.length, f = 1;
                k.each(function() {
                    j += a("#image_od_" + f).width(), em.debug("my width = " + a("#image_od_" + f).width()), 
                    f++;
                }), em.debug("slider width " + j), "horizontal" === d.slide_direction && a(d.class_rendered).find(d.slide_holder).width(l * j);
            } else a(c).find("img").each(function() {
                a(this).clone().appendTo(d.class_frame).attr("id", "image_od_" + f), a(c).find("img").attr("id", "od_" + f), 
                f++;
            });
            switch ("" !== d.title && d.show_header && a("<h1>" + d.title + "</h1>").appendTo(d.class_content), 
            d.type) {
              case "image":
                ...
                var m = a(c).find("img").attr("src"), n = a(c).find("img").attr("id"), o = a("#image_" + n).width(), p = a("#image_" + n).height();
                (Number(a(b).height()) - Number(p)) / 2, (Number(a("body").width()) - Number(o)) / 2, 
                "" !== d.title && (a('<div class="' + em.cla(d.class_caption) + '"><h1>' + d.title + "</h1></div>").appendTo(d.slide_holder), 
                a(d.class_caption).fadeTo("slow", .6)), em.debug("gallery is " + e), e || (a('<img src="' + m + '" alt="' + d.title + '" height="auto" width="auto" /></div>').appendTo(d.class_images), 
                a(d.class_rendered).find(d.slide_holder).width(o).height(p));
                break;
              ...
              case "external":
                for (var q = {}, r = d.params.split(","), f = 0; f < r.length; f++) {
                    var s = r[f].split(":");
                    q[s[0]] = s[1];
                }
                a.ajax({
        ...
        afterraise: function(c, d) {
            ...
            d.focus_first && a(d.class_rendered).find("input").first().trigger("focus"), d.force_scroll && a(d.class_rendered).find(d.class_content).css("overflow-y", "scroll").css("overflow-x", "hidden").height(total_height), 
        ...
        shell: function(b, c) {
            em.debug("super proto build shell"), a(c.class_rendered).length || (a("<div/>", {
        ...
        clean: function(b, c) {
            em.debug("super proto clean house"), a(c.class_rendered).length, a(c.class_bg).removeClass(c.class_spinner), 
            a("body").trigger("show_overlay");
        },
        raise: function(c, d) {
            em.debug("super proto open");
            var e = "user" == d.width ? "auto" : d.width, f = "user" == d.height ? "auto" : d.height, g = (Number(a(b).height()) - Number(f)) / 2, h = (Number(a("body").width()) - Number(e)) / 2;
            f = "user" != d.max_height && f > d.max_height ? d.max_height : f, outerOverlay = {
            ...
            }, finalHeight = parseInt(f) + parseInt(outerOverlay.paddingHeight), finalWidth = parseInt(e) + parseInt(outerOverlay.paddingWidth), 
        ...
        close: function() {
            em.debug("super proto close"), this.stop(), a(this.settings.class_rendered).fadeOut(), 
            a(this.settings.class_bg).hide(), a(b).unbind("scroll"), a("body").trigger("close_overlay");
        },
        shadow: function(b, c) {
        ...
        rounded: function(b, c) {
            em.debug("----234523452345------"), em.debug(this.scope.el), em.debug("----234523452345------"), 
        ...
        move: function(b, c, d) {
            ...
            switch (e.stop(), d) {
              case "next":
                if ("vertical" === c.direction) em.debug("upward"); else {
                    em.debug("forward/next");
                    var f = a(b).attr("id").split("_")[2], g = a(c.class_frame).find("#image_od_" + (parseInt(f) + 1)).width(), h = a(c.class_frame).find("#image_od_" + (parseInt(f) + 1)).height(), i = a("#set_" + c.gallery + "_" + f).attr("title"), j = -(f * g - g), k = -(f * h - h), l = 0, m = 0;
                    em.debug_all(f, g, h, i, j, k, l, m), "fade" == c.slide_effect ? (a(c.class_rendered).find(".slide").fadeOut(), 
                    a(c.class_rendered).find(".slide").eq(f - 1).fadeIn(), a(c.class_rendered).find(".slide_holder").css("top", 0), 
                    a(c.class_rendered).animate({
                        width: g,
                        height: h
                    }, c.slide_delay, function() {
                        e.reposition(c);
                    }), a(c.class_rendered).find(".slider").animate({
                        width: g,
                        height: h
                    }, c.slide_delay)) : (a(c.class_frame).find("img").each(function() {
                        l += a(this).find("img").width(), m += a(this).find("img").height();
                    }), "horizontal" === c.slide_direction ? (a(b).find(".slide_holder").animate({
                        left: "-=" + g + "px"
                        ...
                        width: g,
                        height: h
                    }, c.slide_delay), a(c.class_rendered).find(".slide_holder").animate({
                        left: "-=" + g + "px"
                    }, c.slide_delay)) : (a(b).find(".slide_holder").animate({
                        top: k
                    }, c.slide_delay), a(c.class_rendered).animate({
                        width: g,
                        height: h
                        ...
                        top: "-" + m
                    }, c.slide_delay))), "" !== c.title && (a(c.class_caption).find("h1").text(c.title), 
                    a(c.class_caption).fadeTo("slow", .6));
                }
                break;

              case "prev":
                "vertical" === c.direction ? em.debug("down") : em.debug("back/previous");
                break;
        ...
        play: function() {},
        stop: function() {
            em.debug("super stop"), clearInterval(f);
        },
        jump_to: function() {
            em.debug("super jump");
        },
    ...
    var i = e.prototype;
    em.addInitalisation(g, function() {
        em.debug(g + " initialized"), a(h).each(function() {
            var b = a(this);
            return b.data(g) ? !0 : (b.data(g, !0), new e(b), void 0);
        });
        var f = a("[data-gallery^=]"), j = "", k = 0, l = 1;
        f.each(function() {
            a(this).addClass("gallery");
            var b = a(this).data("gallery"), c = a(this).next().data("gallery");
            a(this).prev().data("gallery"), j !== b ? (a(this).addClass("isFirst"), l = 1) : (c !== b || c === d) && a(this).addClass("isLast"), 
            a(this).attr("id", "set_" + b + "_" + l), l++, j = a(this).data("gallery"), k = a(this).index();
        }), a(c).on("click", h, function() {
            return em.debug("super init show"), new e(a(this), "trigger"), !1;
        }), a(c).on("keyup", function(a) {
            27 === a.keyCode && (em.debug("super proto esc"), i.close());
        }), a(b).resize(function() {
        ...
        events: [],
        init: function() {
            em.debug("run " + g + " init"), em.initialize(g);
        }
    });
