(function(a, b) {
    ...
    d.prototype = {
        ...
        shell: function(b, c) {
            ...
            }).prependTo(c.class_rendered), a(b).hasClass("gallery") ? (a("<div/>", {
        ...
        raise: function(c, d) {
            ...
            var e = "user" == d.width ? "auto" : d.width, f = "user" != d.max_height && f > d.max_height ? d.max_height : f, g = (Number(a(b).height()) - Number(f)) / 2, h = (Number(a("body").width()) - Number(e)) / 2, i = {
        ...
        bg: function(c, d) {
            em.debug("super bg"), a(d.class_bg).length || a("<div/>", {
                id: em.cla(d.class_bg),
                "class": em.cla(d.class_bg) + " " + em.cla(d.class_spinner)
            }).appendTo("body"), a(d.class_bg).fadeTo("fast", "0.60").css("top", a(b).scrollTop());
        },
