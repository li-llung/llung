(function(a, b) {
    ...
    d.prototype = {
            ...
            switch (d.type) {
              case "gallery":
                ...
                a("[data-gallery^=" + d.gallery + "]").find("img").each(function(b) {
                    a(this).attr("id", "od_" + b), a(this).clone().appendTo(d.class_frame).attr("id", "image_od_" + b), 
                    a(this).clone().appendTo(d.slide_holder).attr("id", "holder_od_" + b), e++;
                });
                ...
                em.debug(g), a(d.class_rendered).data("current-slide", g), a("[data-gallery^=" + d.gallery + "]").find("img").each(function(b) {
                    g > b + 1 && (h += a("#image_od_" + b).width(), i += a("#image_od_" + b).height(), 
                    em.debug(a("#image_od_" + b).width()), em.debug(a("#image_od_" + b).height())), 
                    e++;
        ...
        move: function(b, c, d) {
            ...
            var g = Number(a(c.class_rendered).data("current-slide")), h = Number(a(c.class_rendered).data("current-slide")), i = "-";
            ...
            var j = a("#image_od_" + g).width(), k = a("#image_od_" + g).height(), l = c.title, m = -(g * a("#image_od_" + h).width() - a("#image_od_" + h).width()), n = -(g * a("#image_od_" + h).height() - a("#image_od_" + h).height()), o = 0, p = 0;
            "fade" == c.slide_effect ? (a(c.class_rendered).find("img").fadeOut(), a(c.class_rendered).find("img").eq(g).fadeIn(), 
            a(c.class_rendered).find(c.slide_holder).css("top", 0), a(c.class_rendered).animate({
                width: j,
                height: k
                ...
                width: j,
                height: k
            }, c.slide_delay)) : (a(c.class_rendered).find("img").each(function(b) {
                em.debug(b + 1), em.debug(g), g > b + 1 && (o += a(this).width(), p += a(this).height(), 
                em.debug("pushing " + o));
            }), "horizontal" === c.slide_direction ? (j = a("#image_od_" + h).width(), k = a("#image_od_" + h).height(), 
            a(c.class_rendered).find(c.slide_holder).animate({
                left: m
            ...
            a(c.class_next).show()) : (a(c.class_prev).show(), a(c.class_next).show()), a("#image_od_" + g).is(":last-child") && (a(c.class_prev).show(), 
            a(c.class_next).hide()), a("#image_od_" + g).is(":first-child") || a("#image_od_" + g).is(":last-child") || (a(c.class_prev).show(), 
            a(c.class_next).show()), "" !== l && (a(c.class_caption).find("h1").text(l), a(c.class_caption).fadeTo("slow", .6));
        },
        play: function() {
