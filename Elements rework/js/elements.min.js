(function(a, b) {
    ...
    e.prototype = {
        ...
        show: function(b, c) {
            ...
            var d = this;
            em.debug("----------"), em.debug(d.config), em.debug(d.config.is_first()), em.debug(d.config.is_last()), 
            a(b).hasClass("gallery") && (em.debug(d.config.get_id()), em.debug(d.config.get_slide())), 
            em.debug("----------"), d.bg(b, c), d.shell(b, c), d.populate(b, c), d.bling(b, c), 
            d.raise(b, c), d.afterraise(b, c), d.clean(b, c);
        },
        populate: function(c, d) {
            ...
            if (a(d.class_frame).length ? a(d.class_frame).html("") : a("<div/>", {
                ...
                var j = 0, k = a("[data-gallery^=" + d.gallery + "]"), l = k.length, m = 1;
                k.each(function() {
                    j += a("#image_od_" + m).width(), em.debug("my width = " + a("#image_od_" + m).width()), 
                    m++;
            ...
            d.type) {
              case "image":
                ...
                a(d.class_caption).fadeTo("slow", .6)), em.debug("gallery is " + e), e || (a('<img src="' + n + '" alt="' + d.title + '" height="auto" width="auto" /></div>').appendTo(d.class_images), 
              ...
              default:
                a("#" + d.element).clone(!0, !0).appendTo(d.class_content), a(d.class_content).find(".hidden").show().css("position", "relative").css("margin", "0");
            }
        },
