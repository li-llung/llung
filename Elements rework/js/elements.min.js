(function(a, b) {
    ...
    function d() {
        ...
        this.defaults = {
            ...
            em.updateOptions(a(this), d.settings), d.show(a(this), d.settings), a(c).data(d.settings.class_bg) ? !0 : (a(c).data(d.settings.class_bg, !0), 
    ...
    d.prototype = {
        constructor: d,
        init: function(b, d) {
            return a(c).data(d.class_bg) ? !0 : (a(c).data(d.class_bg, !0), void 0);
        },
        show: function(a, b) {
