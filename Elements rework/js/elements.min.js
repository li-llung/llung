(function(a, b) {
    ...
    d.prototype = {
        ...
        populate: function(c, d) {
            ...
            switch (d.type) {
              case "gallery":
                ...
                var j = ((Number(a(b).height()) - Number(f.height())) / 2, (Number(a("body").width()) - Number(f.width())) / 2), k = 0, l = a("[data-gallery^=" + d.gallery + "]");
                l.length;
                var m = 1;
                l.each(function() {
                    k += a("#image_od_" + m).width(), em.debug("my width = " + a("#image_od_" + m).width()), 
                    m++;
              ...
              case "image":
                ...
                var n = a(c).find("img").attr("src"), o = a(c).find("img").attr("id"), p = a("#image_" + o).width(), q = a("#image_" + o).height();
                (Number(a(b).height()) - Number(q)) / 2, (Number(a("body").width()) - Number(p)) / 2, 
                "" !== d.title && (a('<div class="' + em.cla(d.class_caption) + '"><h1>' + d.title + "</h1></div>").appendTo(d.slide_holder), 
                a(d.class_caption).fadeTo("slow", .6)), a('<img src="' + n + '" alt="' + d.title + '" height="auto" width="auto" /></div>').appendTo(d.class_images), 
                a(d.class_rendered).find(d.slide_holder).width(p).height(q);
                break;
              ...
              case "external":
                for (var r = {}, s = d.params.split(","), t = 0; t < s.length; t++) {
                    var u = s[t].split(":");
                    r[u[0]] = u[t];
                }
                a.ajax({
        ...
        move: function(b, c, d) {
            ...
            -(g * a("#image_od_" + h).height() - a("#image_od_" + h).height())), n = 0, o = 0;
            ...
            a(c.class_rendered).animate({
                ...
                g > b + 1 && (n += a(this).width(), o += a(this).height(), em.debug("pushing " + a(this).width()));
            }), em.debug(n), "horizontal" === c.slide_direction ? (em.debug(j), em.debug(k), 
            em.debug(g), em.debug(h), a(c.class_rendered).find(c.slide_holder).animate({
                ...
                width: j,
                height: k
            }, c.slide_delay), n = 0, o = 0) : (a(c.class_rendered).find(c.slide_holder).animate({
                top: m
            }, c.slide_delay), a(c.class_rendered).animate({
                width: j,
                height: k
