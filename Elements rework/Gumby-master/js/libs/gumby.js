...
!function() {
	...
	// public helper - set Elements ready callback
	Elements.prototype.ready = function(code) {
	...
	Elements.prototype.oldie = function(code) {
		if(code && typeof code === 'function') {
			this.onOldie = code;
		}
	};
	...
	Elements.prototype.touch = function(code) {
		if(code && typeof code === 'function') {
			this.onTouch = code;
		}
	};
	...
	Elements.prototype.debug = function() {
		return {
			$dom: this.$dom,
	...
	Elements.prototype.selectAttr = function() {
		var i = 0;
	...
	Elements.prototype.addInitalisation = function(ref, code) {
		this.inits[ref] = code;
	};

	// initialize a uiModule
	Elements.prototype.initialize = function(ref) {
	...
	// store a UI module
	Elements.prototype.UIModule = function(data) {
		var module = data.module;
		this.uiModules[module] = data;
	};

	// loop round and init all UI modules
	Elements.prototype.initUIModules = function() {
		var x;
